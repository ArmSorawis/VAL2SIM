...
from sim_switch_obstacleDetection_type2 import sim_open_obstacleDetection_node, sim_close_obstacleDetection_node
...
if __name__ == '__main__':
	rospy.init_node('val2sim_fsm_type2_node', anonymous=False)
	main()