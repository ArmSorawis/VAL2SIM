...
# 									node_type='val2sim_fsm_type1_pause.py', 
# 									name='val2sim_fsm_type1_pause_node',
# 									output='screen')
...
if __name__=="__main__":
	rospy.init_node('type1_pause_subscriber_node')
	guiSub_node = gui_pause_subscriber()
	type1Pause_node = type1_pause_publisher()
	...
	try:
		while(not rospy.is_shutdown()):
			...
			if command == "pause":
				type1Pause_node.publish_velocity()
			r.sleep()
