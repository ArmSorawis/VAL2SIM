...
caPath = r'/home/kitti/catkin_ws/src/aws_communication/cer/RootCA.pem'
certPath = r'/home/kitti/catkin_ws/src/aws_communication/cer/certificate.crt'
keyPath = r'/home/kitti/catkin_ws/src/aws_communication/cer/private.key'
...
while 1==1:
    ...
    if connflag == True:
        ...
        mqttc.publish("$aws/things/CUROBOT/mobile", tempreading, qos=1)
